...
import 'call_support_model.dart';
export 'call_support_model.dart';

class CallSupportWidget extends StatefulWidget {
  const CallSupportWidget({super.key});

  @override
  _CallSupportWidgetState createState() => _CallSupportWidgetState();
}

class _CallSupportWidgetState extends State<CallSupportWidget> {
  late CallSupportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CallSupportModel());
  }
          ...
          children: [
            ...
            Align(
              ...
              child: ClipRRect(
                ...
                child: Image.asset(
                  'assets/images/Screenshot_2023-12-19_042121.png',
                  width: 307.0,
                  height: 382.0,
                  fit: BoxFit.fill,
                ),
